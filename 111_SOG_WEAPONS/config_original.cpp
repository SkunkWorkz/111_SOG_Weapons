...
class CfgMagazines
{
	...
	{
		scope = 6;
		displayName = "12Ga. Tungsten Flechettes";
		displayNameShort = "Tungsten Flechettes";
		descriptionShort = "Caliber: 12 Gauge<br/>Rounds: 7<br/>Used in: Shotgun";
	...
	{
		scope = 6;
		displayName = "12Ga. Tungsten Sabot";
		displayNameShort = "Sabot Tungsten";
		descriptionShort = "Caliber: 12 Gauge<br/>Rounds: 7<br/>Used in: Shotgun";
	...
	{
		scope = 6;
		displayName = "12Ga. Stun";
		displayNameShort = "Stun Shells";
		descriptionShort = "Caliber: 12 Gauge<br/>Rounds: 7<br/>Used in: Shotgun";
